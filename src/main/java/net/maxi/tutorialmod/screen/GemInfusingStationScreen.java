package net.maxi.tutorialmod.screen;

import com.mojang.blaze3d.systems.RenderSystem;
import com.mojang.blaze3d.vertex.PoseStack;
import net.maxi.tutorialmod.TutorialMod;
import net.maxi.tutorialmod.screen.renderer.EnergyInfoArea;
import net.maxi.tutorialmod.screen.renderer.FluidTankRenderer;
import net.maxi.tutorialmod.util.MouseUtil;
...
public class GemInfusingStationScreen extends AbstractContainerScreen<GemInfusingStationMenu> {
    ...
    protected void renderLabels(PoseStack pPoseStack, int pMouseX, int pMouseY) {
        ...
        rendererFluidAreaTooltips(pPoseStack, pMouseX, pMouseY, x, y);

    }

    private void rendererFluidAreaTooltips(PoseStack pPoseStack, int pMouseX, int pMouseY, int x, int y) {
